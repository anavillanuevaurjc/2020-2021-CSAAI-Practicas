...
const ESTADO = {
    ...
    OPERATION: 2,
    OP2: 3,
  } /* Asignacion de numeros para saber en que estado estamos */

//-- Variable de estado
//-- Por defecto su valor será el del estado inicial
let estado = ESTADO.INIT; /* indica que estamos en estado inicial */

//-- Función de retrollamada de los digitos
/* Para que solo aparezca el primero */

/* Podemos ir encadenando los if del estado deseado */
